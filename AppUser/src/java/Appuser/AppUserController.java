...
import Appuser.util.JsfUtil;
import Appuser.util.PaginationHelper;
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private Appuser.AppUserFacade ejbFacade;
    ...
    public String create() {
     String passwordEntry = current.getPassword(); //pretend the user has chosen a password mySecretPassword
     
     //salted password given
     current.setPassword(passwordEntry);
        try {
